 ...
 * 2015版权所有
 */
package com.eastcom.baseframe.common.utils.gson;
...
public class GsonTools {
	 ...
	 * @see org.xdemo.superutil.thirdparty.gson.GsonTools#GsonTools(GsonExclusion,
	 *      GsonKeyRename)
	 * @see org.xdemo.superutil.thirdparty.gson.GsonTools#GsonTools(boolean,
	 *      String, GsonExclusion, GsonKeyRename)
	 * @param object
	 * @return
	 */
	public static String toJson2(Object object) {
		return new GsonBuilder().serializeNulls()
				.setDateFormat("yyyy-MM-dd HH:mm:ss").create().toJson(object);
	}
	...
	public GsonTools(boolean serializeNulls, String dateFormat,
					 GsonExclusion exclusion, GsonKeyRename keyRename) {
