package com.eastcom.baseframe.common.utils.excel;

import com.eastcom.baseframe.common.utils.gson.GsonTools;
...
public class CustomizeToExcel {
	 ...
	 * @throws Exception
	 */
	public static void toFile(Workbook wb,String filePath) throws Exception {
		...
		for (int c = 0; c < colsCount; c++) {
			...
			for (int r = rowsCount - 1; r > -1; r--) {
				...
				if (cell != null && r == rowsCount - 1) {
					...
					RegionUtil.setBorderLeft(1, new CellRangeAddress(rowsCount - rowSpan - 1, rowsCount - 1, c, c), sheet, wb);
					RegionUtil.setBorderRight(1, new CellRangeAddress(rowsCount - rowSpan - 1, rowsCount - 1, c, c), sheet, wb);
					RegionUtil.setBorderTop(1, new CellRangeAddress(rowsCount - rowSpan - 1, rowsCount - 1, c, c), sheet, wb);
					RegionUtil.setBorderBottom(1, new CellRangeAddress(rowsCount - rowSpan - 1, rowsCount - 1, c, c), sheet, wb);
			...
			for (int c = 0; c < colsCount; c++) {
				...
				if (cell2 == null) {// 说明当前行已经到最后一个单元格了
					if (colSpan >= 1) {// 判断colSpan是否大于等于1，大于1就要合并了
						...
						RegionUtil.setBorderLeft(CellStyle.BORDER_THIN, new CellRangeAddress(r, r, c - colSpan, c), sheet, wb);
						RegionUtil.setBorderRight(CellStyle.BORDER_THIN, new CellRangeAddress(r, r, c - colSpan, c), sheet, wb);
						RegionUtil.setBorderTop(CellStyle.BORDER_THIN, new CellRangeAddress(r, r, c - colSpan, c), sheet, wb);
						RegionUtil.setBorderBottom(CellStyle.BORDER_THIN, new CellRangeAddress(r, r, c - colSpan, c), sheet, wb);
						break;
					}
				}
	...
	private static void writeTitles(JsonArray array, int rowIndex, String parentTitle) {
		...
		while (it.hasNext()) {
			...
			// 设置前景色
			cs.setFillForegroundColor(new XSSFColor(new java.awt.Color(220, 220, 220)));
			...
			for (int i = 0; i < count; i++) {
				...
				if (isLeaf) {
					...
					if (e.getAsJsonObject().get("width") != null && e.getAsJsonObject().get("width").getAsInt() != 0) {
						...
						sheet.setColumnWidth(_colIndex - 1, e.getAsJsonObject().get("width").getAsInt() * 256 / 7);
					}
				}
	...
	public static void main(String[] args) throws Exception {
		...
		CustomizeToExcel.toFile("[{\"title\":\"A\",\"field\":\"A\",\"width\":22},{\"title\":\"B\",\"field\":\"B\",\"width\":20,\"children\":[{\"title\":\"C\",\"field\":\"C\",\"width\":30},{\"title\":\"D\",\"field\":\"D\",\"width\":30},{\"title\":\"E\",\"field\":\"E\",\"width\":30,\"children\":[{\"title\":\"X\",\"field\":\"X\",\"width\":22},{\"title\":\"Y\",\"field\":\"Y\",\"width\":22,\"children\":[{\"title\":\"EE\",\"field\":\"EE\",\"width\":22},{\"title\":\"SS\",\"field\":\"SS\",\"width\":22,\"children\":[{\"title\":\"uu\",\"field\":\"uu\",\"width\":22},{\"title\":\"i\",\"field\":\"i\",\"width\":22},{\"title\":\"o\",\"field\":\"o\",\"width\":22}]}]}]}]},{\"title\":\"Z\",\"field\":\"Z\",\"width\":22}]",
						list, "D:\\x1.xlsx");
