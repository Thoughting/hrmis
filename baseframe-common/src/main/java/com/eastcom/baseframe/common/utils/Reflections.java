...
public class Reflections {
	 ...
	 * @return
	 */
	public static Annotation[] getGetterAnnotations(Object obj,
			String propertyName) {
	 ...
	 * @return
	 */
	public static <T extends Annotation> Annotation getGetterAnnotation(
			Object obj, String propertyName, Class<T> annotationClass) {
		String getterMethodName = GETTER_PREFIX
				+ StringUtils.capitalize(propertyName);
		Method method = getAccessibleMethod(obj, getterMethodName);
	...
	public static Object getInstance(String className, Class[] argsClass,
			Object[] args) {
	...
	public static Object invoke(Class<?> cls, Object obj, String methodName,
			Class[] argsClass, Object[] args) {
		Object returnObj = null;
		Method method = null;
		try {
			...
			if (!(cls.equals(Object.class))) {
				returnObj = invoke(cls.getSuperclass(), obj, methodName,
						argsClass, args);
			}
	...
	public static List<Map<String, Object>> getFieldsInfo(Object o) {
		...
		for (int i = 0; i < fields.length; i++) {
			...
			infoMap.put("value", getFieldValue(o, fields[i].getName()));
			list.add(infoMap);
		}
		return list;
	}
	...
	public static void setter(Class<?> cls, Object obj, String fieldName,
		...
		try {
			...
			mName = "get"
					+ mName.replaceFirst(
							new StringBuilder(String.valueOf(mName.charAt(0)))
									.toString(),
							new StringBuilder(String.valueOf(mName.charAt(0)))
	...
	public static String toString(Object obj, String prot) {
		...
		do {
			...
			for (int i = 0; i < fields.length; ++i) {
				...
				if ((vv != null)
						&& (((vv.getClass().equals(Date.class)) || (vv
								.getClass().getSuperclass().equals(Date.class)))))
