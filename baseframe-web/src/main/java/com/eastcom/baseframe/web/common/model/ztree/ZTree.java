package com.eastcom.baseframe.web.common.model.ztree;
 ...
 * @version 1.0 <br>
 * @creatdate 2014-5-22 下午3:16:09 <br>
 * 
 */
public class ZTree implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7675495483497088899L;
	 ...
	 * 默认值：无
	 */
	private List<? extends ZTree> children;
	/**
	...
	public ZTree(String id, String name) {
		this.id = id;
		this.name = name;
	}

	public ZTree(String id, String name, Boolean noCheck, Boolean isParent) {
		this.id = id;
		this.name = name;
	...
	// return children;
	// }
	public List<? extends ZTree> getChildren() {
		return children;
	}

	public void setChildren(List<? extends ZTree> children) {
	...
	public <T extends ZTree> void addChildren(T tree) {
