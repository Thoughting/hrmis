...
import com.eastcom.baseframe.common.utils.Encodes;
...
public class Servlets {
	...
	// 静态文件后缀
	private final static String[] staticFiles = StringUtils.split(
			Global.getConfig("web.staticFile"), ",");
	 ...
	 * @return
	 */
	public static String getHref(HttpServletRequest request) {
		String uri = getRequestURI(request);
		String path = getContextPath(request);

		return StringUtils.equals(path, "/") ? uri : StringUtils
				.removeStartIgnoreCase(uri, path);
	}
}
