...
@Repository
public class AreaDaoImpl extends TreeDaoSupport<Area> implements AreaDao{
	...
	public void update(String id, String parentId, int sort) throws Exception {
		this.executeBySql(" update T_SYS_AREA t set parent_id = ? , sort = ? where id = ?",new Object[]{parentId,sort,id});
	}
