// 用户管理
$.namespace('sys.dictMgr');

//界面变量
Constant = {
	init : function(){
		Constant.$grid_list_url = basePath + '/api/sys/dict/treeList';
		Constant.$addEdit_form_url = basePath + "/api/sys/dict/addOrUpdate";
		Constant.$delete_url = basePath + "/api/sys/dict/delete";
		Constant.$saveSort_url = basePath + "/api/sys/dict/saveSort";
	},
	//得到树图父子关系以及排序信息
	...
	init : function(){
		...
		$("#editBtn").on("click",function(){
			...
			if (selectNode != null) {
				...
				$("#ud_type").textbox("setValue",selectNode.type);
