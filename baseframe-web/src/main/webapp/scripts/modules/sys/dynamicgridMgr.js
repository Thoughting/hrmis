...
Constant = {
	init : function(){
		Constant.$grid_list_url = basePath + '/api/sys/dynamicgrid/list';
		Constant.$addEdit_form_url = basePath + "/api/sys/dynamicgrid/addOrUpdate";
		Constant.$delete_url = basePath + "/api/sys/dynamicgrid/delete";
	}
}
		...
		$("#editBtn").linkbutton({
			onClick : function(){
				...
				if (selectNode != null) {
					...
					$("#ud_headDepth").textbox("setValue",selectNode.headDepth);
