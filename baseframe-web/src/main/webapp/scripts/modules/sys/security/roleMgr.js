...
Component = {
	init : function(){
		...
		Component.$authAreaTree = $("#authAreaTree");
	}
}
	...
	init : function(){
		...
		$("#addAuthBtn").linkbutton({
			onClick : function(){
				...
				if (selectNode != null) {
					...
					Component.$authAreaTree.tree({
						url : Constant.$authAreaTreeList,
						onBeforeLoad : function(node, param){
							param.id = selectNode.id;
						}
					});
		...
		$("#confirmAuthBtn").linkbutton({
			onClick : function(){
				...
				var checkAreaNodes = Component.$authAreaTree.tree('getChecked');
				var selectNode = Component.$grid.datagrid('getSelected');
				if (checkResourceNodes != null && checkAreaNodes != null && selectNode != null) {
					...
					$.ajax({
						...
						data : {
							...
							checkAreaNodes : JSON.stringify(checkAreaNodes),
