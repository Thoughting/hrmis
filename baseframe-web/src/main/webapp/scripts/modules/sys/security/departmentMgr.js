// 用户管理
$.namespace('sys.security.departmentMgr');

//界面变量
Constant = {
	init : function(){
		Constant.$grid_list_url = basePath + '/api/sys/department/treeList';
		Constant.$addEdit_form_url = basePath + "/api/sys/department/addOrUpdate";
		Constant.$delete_url = basePath + "/api/sys/department/delete";
		Constant.$saveSort_url = basePath + "/api/sys/department/saveSort";
	},
	//得到树图父子关系以及排序信息
