...
Constant = {
	init : function(){
		Constant.$grid_list_url = basePath + '/api/emp/wagecountitem/treeList';
		Constant.$addEdit_form_url = basePath + "/api/emp/wagecountitem/addOrUpdate";
		Constant.$delete_url = basePath + "/api/emp/wagecountitem/delete";
		Constant.$saveSort_url = basePath + "/api/emp/wagecountitem/saveSort";
	},
	//得到树图父子关系以及排序信息
	...
	init : function(){
		...
		$("#editBtn").on("click",function(){
			...
			if (selectNode != null) {
				...
				$("#ud_showWidth").textbox("setValue",selectNode.showWidth);
				$("#ud_showFormatter").textbox("setValue",selectNode.showFormatter);
