...
<script src="${ctxScripts}/modules/emp/wages/employeeWageItemMgr.js"></script>
<script type="text/javascript">
var hasGridEdit = <%=SecurityCache.hasPermission("emp:employeewageitemmgr:edit")%>;
				...
				<table style="line-height:26px;padding: 10px;padding-bottom: 0px;">
					<tr>
						...
						<td>
	        				...
	        				<shiro:hasPermission name="emp:employeewageitemmgr:export">
