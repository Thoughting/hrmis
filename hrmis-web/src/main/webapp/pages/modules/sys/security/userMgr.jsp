...
<body>
	<div class="easyui-layout" style="width:100%;height:650px;">
	    <div data-options="region:'center'">
		    <table id="datagrid" class="easyui-datagrid" fit="true" pageSize="20"
		        ...
		        <thead>
		            <tr>
		                ...
		                <th field="deptNames" width="50">授权项目</th>
		            </tr>
		        </thead>
		    </table>
		    <div id="toolbar">
				...
				<div style="float: right;">
					<input id="searchText" style="width: 200px;" class="easyui-textbox" type="text" prompt="请输入用户名..."></input>
